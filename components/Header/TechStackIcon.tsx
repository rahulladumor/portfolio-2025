...
const TechStackIcon: React.FC<TechStackIconProps> = ({ Icon, color, name, delay, isHovering, mousePosition }) => {
  return (
    <motion.div
      whileHover={{
        scale: 1.2,
      ...
      style={{
        ...
        transform: isHovering
          ? `perspective(1000px) rotateY(${(mousePosition.x - 150) / 20}deg) rotateX(${
