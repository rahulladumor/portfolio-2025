      ...
      <div className="lg:col-span-9 space-y-8">
        ...
        >
          <p className="text-xl font-medium text-gray-900 dark:text-white">
            Hey there! 👋 I'm Rahul Ladumor
          </p>
          
          <p className="text-gray-600 dark:text-gray-300">
            As the Founder & CEO of CodeLamda Technologies, I bring over 7 years of experience in transforming
            businesses through innovative technology solutions. My expertise in cloud architecture and AI
            implementation has helped companies scale their operations efficiently and effectively.
          </p>
        </motion.div>
          ...
          {highlights.map((highlight, index) => (
            ...
            >
              <div className="flex items-center gap-4 mb-3">
                <div className="p-2 rounded-lg bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10
        ...
        >
          <p className="text-gray-600 dark:text-gray-300">
            ...
            and Full Stack Development. I'm particularly passionate about serverless architectures and enterprise-grade
            AI implementations.
          </p>
          ...
          <p className="text-gray-600 dark:text-gray-300">
            ...
            <a href="#contact" className="text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300"> contact section</a> or visit <a href="https://codelamda.com" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-600 dark:text-blue-400 dark:hover:text-blue-300">CodeLamda</a>.
          </p>
        </motion.div>
      </div>
    </div>
