      ...
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-start gap-4">
          ...
          >
            {certification.isAWS ? (
              ...
              <div className="w-5 h-5 relative">
                {certification.icon ? (
                  <Image src={certification.icon} alt={certification.title} layout="fill" objectFit="contain" />
                ) : (
          ...
          <div>
            ...
            <p className="mt-1 text-gray-600 dark:text-gray-300">{certification.subtitle}</p>
            {certification.validUntil && (
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Valid until: {certification.validUntil}</p>
            )}
          </div>
        </div>
